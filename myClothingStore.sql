...
CREATE TABLE tblSellerRequests (
    ...
    UNIQUE KEY uq_seller_request_user (user_id),
...
INSERT INTO tblProducts (seller_id, category_id, title, description, price, `condition`, image, status) VALUES
